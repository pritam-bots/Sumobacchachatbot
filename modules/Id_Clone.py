...
from ROCKY import ROCKY as app, save_clonebot_owner, save_idclonebot_owner
from ROCKY import ROCKY, db as mongodb
    ...
    if len(message.command) > 1:
        ...
        try:
            ai = Client(
                ...
                no_updates=False,
                plugins=dict(root="ROCKY.idchatbot"),
            )
            await ai.start()
