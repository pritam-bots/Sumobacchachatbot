...
from ROCKY.database.chats import add_served_chat
from ROCKY.database.users import add_served_user
from config import MONGO_URL, OWNER_ID
from ROCKY import ROCKY, mongo, LOGGER, db
from ROCKY.modules.helpers import chatai, storeai, languages, CHATBOT_ON
...
@ROCKY.on_message(filters.command(["lang", "language", "setlang"]))
...
@ROCKY.on_message(filters.command("status"))
...
@ROCKY.on_message(filters.command(["resetlang", "nolang"]))
...
@ROCKY.on_message(filters.command("chatbot"))
